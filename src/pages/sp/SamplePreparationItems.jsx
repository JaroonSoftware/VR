...
import { itemsColumn } from "./sample-preparation.model"; 
// import ItemService from "../../service/ItemService";
import OptionService from "../../service/Options.service"

const opnService = OptionService();
export default function SamplePreparationItems({show, close, values, selected}) {
    ...
    const column = itemsColumn( { handleSelectItems, handleCheckDuplicate } );
