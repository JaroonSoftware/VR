...
// import { ModalQuotationManage } from './modal-quotation.js';

import { customersColumn } from "./modal-quotation.model.js";
import OptionService from '../../../service/Options.service.js';

const opservice = OptionService();

export default function ModalQuotation({show, close, values, selected}) {
    const [form] = useForm(); 
                            ...
                            <Row gutter={[{xs:32, sm:32, md:32, lg:12, xl:12}, 8]} className='m-0'>
                                <Col span={24}>
                                    <Form.Item label="ค้นหา"  >
                                        <Input suffix={<SearchOutlined />} onChange={ (e) => { handleSearch(e.target.value) } } placeholder='ค้นหาใบเสนอราคา'/>
                                    </Form.Item>                        
                                </Col> 
                            </Row> 
                            {/* <Row gutter={[{xs:32, sm:32, md:32, lg:12, xl:12}, 8]} className='m-0'>
