...
import { Divider, Form, Input, Button, Flex, message, AutoComplete, Radio, Select } from "antd";
import { Row, Col, Space } from "antd";

import { SaveFilled } from  "@ant-design/icons";

import { suppliers } from '../../../pages/suppliers/suppliers.model.js';  
...
const ModalSupplierManage = ({submit}) => { 
    ...
    const init = async () => {  
        const supcodeRes = await spiService.getcode().catch( () => message.error("Initail failed"));
